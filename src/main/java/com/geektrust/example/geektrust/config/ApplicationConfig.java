...
public class ApplicationConfig {
    private final RouteRepositoryInterface routeRepositoryInterface = new RouteRepository();
    ...
    private final ITrainService iTrainService = new TrainService(routeRepositoryInterface, iTrainRepository, iBogieRepository,
            iStationRepository);

    private final ICommand loadDataCommand = new DataCommand(iStationRepository, routeRepositoryInterface);
